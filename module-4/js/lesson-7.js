...
// ключа, який зберігається в змінній, а використати
...
// ми звертаємося через крапку, щоб отрмати доступ
// значення властивості.
// Якщо ні, то використовуємо квадратні дужки.

// =============== ЗМІНА ЗНАЧЕНЯ ВЛАСИВОСТЕЙ
...
// назвою змінної і за доомогою крапки 
...
// яке зберігається під ключем зхованим в 
